...
class LLaVATrainer(Trainer):
    ...
    def get_train_dataloader(self) -> DataLoader:
        ...
        if not isinstance(train_dataset, torch.utils.data.IterableDataset):
            ...
            dataloader_params["drop_last"] = True #self.args.dataloader_drop_last
    ...
    def create_optimizer(self):
        ...
        if self.optimizer is None:
            ...
            if self.args.mm_projector_lr is not None:
                ...
                projector_parameters.extend([name for name, _ in opt_model.named_parameters() if "zip" in name])
    ...
    def _save_checkpoint(self, model, trial, metrics=None):
        ...
        # Only save Adapter
        keys_to_match = ['mm_projector', 'vision_tower', 'vision_resampler', 'zip_compressor', 'zip_prefusion_layers']
        if getattr(self.args, "use_im_start_end", False):
            keys_to_match.extend(['embed_tokens', 'embed_in'])
